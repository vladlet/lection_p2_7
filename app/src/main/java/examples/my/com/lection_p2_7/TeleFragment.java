...
public class TeleFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		_root = inflater.inflate(R.layout.tele_layout, container, false);
	...
	private void setTextViewText(int id, String text) {
		...
		((TextView) _root.findViewById(id)).setText(text);
	}
	...
	private void setSignalLevel(int id, int infoid, int level) {
		...
		((ProgressBar) _root.findViewById(id)).setProgress(progress);
		((TextView) _root.findViewById(infoid)).setText(signalLevelString);
	...
	private void setDataDirection(int id, int direction) {
		...
		((ImageView)_root.findViewById(id)).setImageResource(resid);
	}

	private int getDataDirectionRes(int direction) {
		//int resid = R.drawable.data_none;
		int resid = android.R.drawable.ic_lock_power_off;

		switch (direction) {
			case TelephonyManager.DATA_ACTIVITY_IN:
				//resid = R.drawable.data_in;
				resid = android.R.drawable.arrow_down_float;
				break;
			case TelephonyManager.DATA_ACTIVITY_OUT:
				//resid = R.drawable.data_out;
				resid = android.R.drawable.arrow_up_float;
				break;
			case TelephonyManager.DATA_ACTIVITY_INOUT:
				//resid = R.drawable.data_both;
				resid = android.R.drawable.ic_menu_add;
				break;
			case TelephonyManager.DATA_ACTIVITY_NONE:
				//resid = R.drawable.data_none;
				resid = android.R.drawable.ic_lock_power_off;
				break;
			default:
				//resid = R.drawable.data_none;
				resid = android.R.drawable.ic_lock_power_off;
